...
| :-- | :---- | :--------- | :----- | :------------------------------- |
| 1 | User | As a user, I want a stable cross-platform PDF viewer powered by PDFium so I can open, render, navigate, and save PDFs on Windows, macOS, and Linux. | Done | [View Details](./1/prd.md) |
| 2 | User | As a user, I want to edit text and replace images in-place with undo/redo so I can make WYSIWYG changes to PDF content offline. | InProgress | [View Details](./2/prd.md) |
...
| 20260219-110000 | 1 | approve | PBI 1 completed — all tasks Done including E2E tests and scroll bug fix | User |
| 20260219-110000 | 2 | start_implementation | Starting PBI 2 implementation | User |
